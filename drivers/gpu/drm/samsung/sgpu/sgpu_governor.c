...
#define DEFAULT_POLLING_MS			26
#define DEFAULT_VALID_TIME			26
#define DEFAULT_INITIAL_FREQ			1306000
...
#define DEFAULT_LOCAL_MINLOCK_FREQ		1306000
#define DEFAULT_LOCAL_MINLOCK_UTIL		0
#define DEFAULT_LOCAL_MINLOCK_TEMP		165
